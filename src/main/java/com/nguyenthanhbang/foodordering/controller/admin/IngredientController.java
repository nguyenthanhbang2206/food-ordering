...
public class IngredientController {
    ...
    public ResponseEntity<ApiResponse<Ingredient>> createIngredient(@RequestBody IngredientRequest request) throws Exception {
    ...
    public ResponseEntity<ApiResponse<Ingredient>> updateIngredient(@PathVariable Long ingredientId, @RequestBody IngredientRequest request) throws Exception {
    ...
    public ResponseEntity<ApiResponse<List<Ingredient>>> getIngredientsByRestaurant() throws Exception {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteIngredient(@PathVariable Long ingredientId) throws Exception {
